...
restoration_buffered <- restoration_buffered %>%
...
# clean results
restoration_buffered <- do.call(data.frame,
                                lapply(restoration_buffered,
                                       function(x) replace(x, is.infinite(x), NA)))

# join to restoration projects dataframe
restoration_projects <- left_join(restoration_projects, restoration_buffered,
                                  by = "index")

# clean up
rm(waterbodies_303d_lines_url, waterbodies_303d_polygons_url,
   waterbodies_303d_lines, waterbodies_303d_polygons)
```
