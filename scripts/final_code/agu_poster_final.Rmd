...
suggested_vars <- c("slope", "mean_actual_discharge_cfs", "drainage_density",
...
study_points_complete <- study_points[
  complete.cases(st_drop_geometry(dplyr::select(study_points, all_of(suggested_vars)))), ]

# summarize remaining study points
